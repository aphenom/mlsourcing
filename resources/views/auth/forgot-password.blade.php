...
<head>
    ...
    <title>{{ __('global.forgot_password_title') }} - ML Sourcing</title>
...
<div class="container-fluid main-section">
    <div class="d-flex justify-content-center align-items-center w-100 py-5">
        <div class="card-form">
            <h4 class="text-center mb-1 fw-bold">{{ __('global.forgot_password_title') }}</h4>
            <p class="text-center text-muted mb-4" style="font-size:0.9rem;">
                {{ __('global.forgot_password_desc') }}
            </p>
            ...
            <form action="{{ route('password.email') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ old('email') }}"
                        placeholder="{{ __('global.enter_email') }}"
                        required
                        autofocus>
                    @error('email')
