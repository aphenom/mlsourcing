        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.storeRequestForSeller') }}" method="POST" enctype="multipart/form-data" id="request-form">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12 text-end">
                                <a href="{{ route('admin.productRequests') }}" class="btn btn-secondary me-2">{{ __('pages.close') }}</a>
